...
public class CREATURES
{
        ...
        {
                public static LocString NAME = (LocString) UI.FormatAsLink("Hot Ethanol Vapor Vent", "GeyserGeneric_HOT_ETHANOL");
                public static LocString DESC = (LocString) ("A highly pressurized vent that periodically erupts with scalding " + UI.FormatAsLink("Ethanol Vapor", "ETHANOLGAS") + ".");
        }
}